...
class SupremaUserService extends EventEmitter {
    ...
    initializeClients() {
        ...
        this.userClient = new userService.UserClient(gatewayAddress, credentials, clientOptions);
        ...
        this.authClient = new authService.AuthClient(gatewayAddress, credentials, clientOptions);
                ...
                this.userClient.enroll(req, async (err, response) => {
                    if (err) {
                        ...
                        for (const entry of logEntries) {
                            ...
                            entry.success = false;
                            try {
                                await this.prisma.enrollmentLog.create({ data: entry });
                            } catch (dbErr) {
